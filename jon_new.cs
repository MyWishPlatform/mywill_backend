...
namespace NEP5.Contract
{
    ...
    {
        public static string Name() => "jondemo";
        public static string Symbol() => "JDM";
        public static byte Decimals() => 8;
        public static readonly byte[] InitialOwnerScriptHash = "AZvUuHxj1vYMXyF8HoqV5e2Ek5dYZg7i2X".ToScriptHash();
