...
class SubSitePasswordResetForm(PasswordResetForm):
    ...
    def save(self, use_https=False, token_generator=default_token_generator, request=None):
        """
        ...
        for user in self.get_users(to_email):
            ...
            token_generator_link = '{protocol}://{domain}/reset/{uid}/{token}/'.format(protocol=protocol,
            ...
            if subsite_domain == MY_WISH_URL:
                ...
                send_mail(
                    ...
                    password_reset_text.format(subsite_name=subsite_name,
                                               user_display=user,
                                               password_reset_url=token_generator_link), from_email, [user.username])
