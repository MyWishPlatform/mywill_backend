...
def create_eos_json(crowdsale_address, public_key, bytecode, abi, token_address, deployer_address, max_supply,
                    token_short_name, is_transferable_at_once, init_data):
    return {
        "actions": [{
            "account": "eosio",
            "name": "updateauth",
