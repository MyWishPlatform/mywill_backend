...
class ContractDetailsTRONToken(CommonDetails):
    ...
    def deploy(self, eth_contract_attr_name='eth_contract_token'):
        ...
        deploy_params = {
            ...
            # 'abi': str(self.tron_contract_token.abi),
        ...
        print(result.body)
        result = requests.post(tron_url + '/wallet/gettransactionsign', params=result.body)
        print(result)
        result = requests.post(tron_url + '/wallet/broadcasttransaction', params=result.body)
        print(result)
